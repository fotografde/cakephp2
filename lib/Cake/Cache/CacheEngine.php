...
abstract class CacheEngine
{
    ...
    {
        $settings += $this->settings + ['prefix' => 'cake_', 'duration' => 3600, 'probability' => 100, 'groups' => []];
     ...
     */
    abstract public function write($key, mixed $value, $duration);
     ...
     * @return bool True if the data was successfully cached, false on failure
     */
    public function add($key, mixed $value, $duration)
    {
    }
