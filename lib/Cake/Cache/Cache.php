...
class Cache
{
    ...
    protected static function _buildEngine($name)
    {
        ...
        if (static::$_engines[$name]->settings['probability'] && time(
            ) % static::$_engines[$name]->settings['probability'] === 0) {
     ...
     */
    public static function write($key, mixed $value, $config = 'default')
    {
     ...
     */
    public static function add($key, mixed $value, $config = 'default')
    {
