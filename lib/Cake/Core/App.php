...
class App
{
     ...
     * @var string
     */
    final public const PREPEND = 'prepend';
    ...
    protected static function _loadClass($name, $plugin, $type, $originalType, $parent)
    {
        ...
        if ($parent && isset(static::$types[$originalType]['extends'])) {
            ...
            $extendType = $type;
            if (str_contains((string)$extends, '/')) {
    ...
    protected static function _packageFormat()
    {
        if (empty(static::$_packageFormat)) {
            static::$_packageFormat = [
                'Model' => ['%s' . 'Model' . DS],
                'Model/Behavior' => ['%s' . 'Model' . DS . 'Behavior' . DS],
                'Model/Datasource' => ['%s' . 'Model' . DS . 'Datasource' . DS],
                'Model/Datasource/Database' => ['%s' . 'Model' . DS . 'Datasource' . DS . 'Database' . DS],
                'Model/Datasource/Session' => ['%s' . 'Model' . DS . 'Datasource' . DS . 'Session' . DS],
                'Controller' => ['%s' . 'Controller' . DS],
                'Controller/Component' => ['%s' . 'Controller' . DS . 'Component' . DS],
                'Controller/Component/Auth' => ['%s' . 'Controller' . DS . 'Component' . DS . 'Auth' . DS],
                'Controller/Component/Acl' => ['%s' . 'Controller' . DS . 'Component' . DS . 'Acl' . DS],
                'View' => ['%s' . 'View' . DS],
                'View/Helper' => ['%s' . 'View' . DS . 'Helper' . DS],
                'Console' => ['%s' . 'Console' . DS],
                'Console/Command' => ['%s' . 'Console' . DS . 'Command' . DS],
                'Console/Command/Task' => ['%s' . 'Console' . DS . 'Command' . DS . 'Task' . DS],
                'Lib' => ['%s' . 'Lib' . DS],
                'Locale' => ['%s' . 'Locale' . DS],
                'Vendor' => [
                    '%s' . 'Vendor' . DS,
                    ROOT . DS . 'vendors' . DS,
                    dirname((string)CAKE, 2) . DS . 'vendors' . DS,
                ],
                'Plugin' => [
                    APP . 'Plugin' . DS,
                    ROOT . DS . 'plugins' . DS,
                    dirname((string)CAKE, 2) . DS . 'plugins' . DS,
                ],
            ];
        }
