...
class RequestHandlerComponent extends Component
{
     ...
     * @var array
     */
    protected $_inputTypeMap = ['json' => ['json_decode', true]];
     ...
     * @var array
     */
    protected $_viewClassMap = ['json' => 'Json', 'xml' => 'Xml'];
    ...
    public function requestedWith($type = null)
    {
        ...
        [$contentType] = explode(';', (string)env('CONTENT_TYPE'));
        if ($contentType === '') {
            [$contentType] = explode(';', (string)CakeRequest::header('CONTENT_TYPE'));
        }
        if (!$type) {
