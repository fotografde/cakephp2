...
class BasicAuthenticate extends BaseAuthenticate
{
    ...
    public function getUser(CakeRequest $request)
    {
        ...
        if (!strlen((string)$username)) {
            ...
            if (strlen((string)$httpAuthorization) > 0 && str_contains((string)$httpAuthorization, 'Basic')) {
                [$username, $pass] = explode(':', base64_decode(substr((string)$httpAuthorization, 6)));
            }
        }
     ...
     */
    public function unauthenticated(CakeRequest $request, CakeResponse $response): never
    {
