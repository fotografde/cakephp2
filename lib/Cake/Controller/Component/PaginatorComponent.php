...
class PaginatorComponent extends Component
{
     ...
     * @var array
     */
    public $settings = ['page' => 1, 'limit' => 20, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null];
     ...
     * @var array
     */
    public $whitelist = ['limit', 'sort', 'page', 'direction'];
    ...
    protected function _getObject($object)
    {
        ...
        if (empty($object) || $object === null) {
            ...
            if (str_contains((string)$this->Controller->uses[0], '.')) {
                [$name, $className] = explode('.', (string)$this->Controller->uses[0]);
            }
            if ($className) {
    ...
    public function getDefaults($alias)
    {
        ...
        $defaults += ['page' => 1, 'limit' => 20, 'maxLimit' => 100, 'paramType' => 'named', 'queryScope' => null];
        return $defaults;
    }
