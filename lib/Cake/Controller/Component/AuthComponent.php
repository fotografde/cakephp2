...
class AuthComponent extends Component
{
     ...
     * @var array
     */
    public $flash = ['element' => 'default', 'key' => 'auth', 'params' => []];
     ...
     * @var mixed
     */
    public $loginAction = ['controller' => 'users', 'action' => 'login', 'plugin' => null];
        ...
        foreach ($config as $class => $settings) {
            ...
            if (!method_exists($className, 'authorize')) {
                throw new CakeException(
                    __d('cake_dev', 'Authorization objects must implement an %s method.', 'authorize()')
                );
            }
    ...
    public function constructAuthenticate()
    {
        ...
        foreach ($config as $class => $settings) {
            ...
            if (!method_exists($className, 'authenticate')) {
                throw new CakeException(
                    __d('cake_dev', 'Authentication objects must implement an %s method.', 'authenticate()')
                );
            }
            $settings = array_merge($global, (array)$settings);
