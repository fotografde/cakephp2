...
class Shell extends CakeObject
{
     ...
     */
    public function loadModel($modelClass = null, mixed $id = null)
    {
        if ($modelClass === null) {
     ...
     *
     * @param string|null $command The command name to run on this shell. If this argument is empty,
    ...
    {
        CakeLog::config('stdout', ['engine' => 'Console', 'types' => ['notice', 'info'], 'stream' => $this->stdout]);
    }
