...
class ConsoleOptionParser
{
    ...
    public function __construct($command = null, $defaultOptions = true)
    {
        ...
        $this->addOption(
            'help',
            ['short' => 'h', 'help' => __d('cake_console', 'Display this help.'), 'boolean' => true]
        );

        if ($defaultOptions) {
            $this->addOption(
                'verbose',
                ['short' => 'v', 'help' => __d('cake_console', 'Enable verbose output.'), 'boolean' => true]
            )->addOption(
                'quiet',
                ['short' => 'q', 'help' => __d('cake_console', 'Enable quiet output.'), 'boolean' => true]
            );
        }
    }
    ...
    public function addSubcommand($name, $options = [])
    {
        if (is_object($name) && $name instanceof ConsoleInputSubcommand) {
            ...
            $defaults = ['name' => $name, 'help' => '', 'parser' => null];
            $options += $defaults;
