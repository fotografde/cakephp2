...
class ApiShell extends AppShell
{
    ...
    public function main()
    {
        ...
        if (in_array($class, $objects)) {
            if (in_array($type, ['behavior', 'component', 'helper']) && $type !== $file) {
                if (!preg_match('/' . Inflector::camelize($type) . '$/', (string)$class)) {
                    $class .= Inflector::camelize($type);
                }
            }
        } else {
    ...
    public function getOptionParser()
    {
        ...
        )->addOption('method', ['short' => 'm', 'help' => __d('cake_console', 'The specific method you want help on.')]
        );
