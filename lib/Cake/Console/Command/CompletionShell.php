    ...
    public function getOptionParser()
    {
        ...
        $parser->description(
            ...
            [
                ...
                'parser' => ['description' => __d('cake_console', 'List all availables'), 'arguments' => []],
            ]
        )->addSubcommand('subcommands',
            [
                'help' => __d('cake_console', 'Output a list of available subcommands'),
                'parser' => ['description' => __d('cake_console', 'List subcommands for a command'),
                    'arguments' => [
                        'command' => [
            ...
            [
                ...
                'parser' => ['description' => __d('cake_console', 'List options'),
                    'arguments' => [
                        'command' => [
                            'help' => __d('cake_console', 'The command name'),
                            'required' => false,
