...
class TestShell extends Shell
{
    ...
    public function getOptionParser()
    {
        ...
        $parser->description(
            ...
            'category',
            ['help' => __d('cake_console', 'The category for the test, or test file, to test.'), 'required' => false]
        )->addArgument(
            'file',
            ['help' => __d('cake_console', 'The path to the file, or test file, to test.'), 'required' => false]
        )->addOption(
            'log-junit',
            [
            ...
            'log-json',
            ['help' => __d('cake_console', '<file> Log test execution in JSON format to file.'), 'default' => false]
        )->addOption(
            'log-tap',
            ['help' => __d('cake_console', '<file> Log test execution in TAP format to file.'), 'default' => false]
        )->addOption('log-dbus', ['help' => __d('cake_console', 'Log test execution to DBUS.'), 'default' => false]
        )->addOption(
            'coverage-html',
            ['help' => __d('cake_console', '<dir> Generate code coverage report in HTML format.'), 'default' => false]
        )->addOption(
            'coverage-clover',
            ['help' => __d('cake_console', '<file> Write code coverage data in Clover XML format.'), 'default' => false]
        )->addOption(
            'coverage-text',
            ['help' => __d('cake_console', 'Output code coverage report in Text format.'), 'boolean' => true]
        )->addOption(
            'testdox-html',
            [
            ...
            'filter',
            ['help' => __d('cake_console', '<pattern> Filter which tests to run.'), 'default' => false]
        )->addOption(
            'group',
            ['help' => __d('cake_console', '<name> Only runs tests from the specified group(s).'), 'default' => false]
        )->addOption(
            'exclude-group',
            ['help' => __d('cake_console', '<name> Exclude tests from the specified group(s).'), 'default' => false]
        )->addOption('list-groups', ['help' => __d('cake_console', 'List available test groups.'), 'boolean' => true]
        )->addOption(
            'loader',
            ['help' => __d('cake_console', 'TestSuiteLoader implementation to use.'), 'default' => false]
        )->addOption(
            'repeat',
            ['help' => __d('cake_console', '<times> Runs the test(s) repeatedly.'), 'default' => false]
        )->addOption(
            'tap',
            ['help' => __d('cake_console', 'Report test execution progress in TAP format.'), 'boolean' => true]
        )->addOption(
            'testdox',
            [
        ...
        )->addOption('no-colors', ['help' => __d('cake_console', 'Do not use colors in output.'), 'boolean' => true]
        )->addOption('stderr', ['help' => __d('cake_console', 'Write to STDERR instead of STDOUT.'), 'boolean' => true]
        )->addOption(
            'stop-on-error',
            ['help' => __d('cake_console', 'Stop execution upon first error or failure.'), 'boolean' => true]
        )->addOption(
            'stop-on-failure',
            ['help' => __d('cake_console', 'Stop execution upon first failure.'), 'boolean' => true]
        )->addOption(
            'stop-on-skipped',
            ['help' => __d('cake_console', 'Stop execution upon first skipped test.'), 'boolean' => true]
        )->addOption(
            'stop-on-incomplete',
            ['help' => __d('cake_console', 'Stop execution upon first incomplete test.'), 'boolean' => true]
        )->addOption(
            'strict',
            ['help' => __d('cake_console', 'Mark a test as incomplete if no assertions are made.'), 'boolean' => true]
        )->addOption(
            'wait',
            ['help' => __d('cake_console', 'Waits for a keystroke after each test.'), 'boolean' => true]
        )->addOption(
            'process-isolation',
            ['help' => __d('cake_console', 'Run each test in a separate PHP process.'), 'boolean' => true]
        )->addOption(
            'no-globals-backup',
            ['help' => __d('cake_console', 'Do not backup and restore $GLOBALS for each test.'), 'boolean' => true]
        )->addOption(
            'static-backup',
            ['help' => __d('cake_console', 'Backup and restore static attributes for each test.'), 'boolean' => true]
        )->addOption(
            'syntax-check',
            ['help' => __d('cake_console', 'Try to check source files for syntax errors.'), 'boolean' => true]
        )->addOption(
            'bootstrap',
            [
            ...
            'configuration',
            ['help' => __d('cake_console', '<file> Read configuration from XML file.'), 'default' => false]
        )->addOption(
            'no-configuration',
            ['help' => __d('cake_console', 'Ignore default configuration file (phpunit.xml).'), 'boolean' => true]
        )->addOption(
            'include-path',
            [
            ...
            'directive',
            ['help' => __d('cake_console', 'key[=value] Sets a php.ini value.'), 'short' => 'd', 'default' => false]
        )->addOption('fixture', ['help' => __d('cake_console', 'Choose a custom fixture manager.')])->addOption(
            'debug',
    ...
    protected function _parseArgs()
    {
        ...
        $params = ['core' => false, 'app' => false, 'plugin' => null, 'output' => 'text'];
    ...
    protected function _mapFileToCase($file, $category, $throwOnMissingFile = true)
    {
        ...
        $testCaseFolder = str_replace(APP, '', (string)APP_TEST_CASES);
