...
class ServerShell extends AppShell
{
     ...
     * @var int
     */
    final public const DEFAULT_PORT = 80;
    ...
    public function getOptionParser()
    {
        ...
        )->addOption('host', ['short' => 'H', 'help' => __d('cake_console', 'ServerHost')])->addOption(
            'port',
            ['short' => 'p', 'help' => __d('cake_console', 'ListenPort')]
        )->addOption('document_root', ['short' => 'd', 'help' => __d('cake_console', 'DocumentRoot')]);
